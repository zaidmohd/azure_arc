...
With PMK, you can have your clusters deployed on-premises, in public clouds, or at the edge. In this document, we'll explain the steps on how to create an on-premises [BareOS](https://platform9.com/docs/kubernetes/bareos-what-is-bareos) cluster using PMK and connect it to Microsoft Azure Arc.
