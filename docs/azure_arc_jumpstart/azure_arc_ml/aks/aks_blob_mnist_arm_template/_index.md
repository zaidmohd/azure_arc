...
* Azure Machine Learning with:
  ...
  * Model Inference endpoint (pod) invoked using [1. Azure CLI](https://docs.microsoft.com/en-us/cli/azure/ml/endpoint?view=azure-cli-latest#az_ml_endpoint_invoke) and [2. PowerShell native RESTful methods](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.utility/invoke-restmethod?view=powershell-7.1). The second method is to demonstrate that the deployed model can also be called via [Postman](https://www.postman.com/) - or downstream business applications etc.
