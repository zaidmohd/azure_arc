...
* [Tagging and querying server inventory across multiple clouds using Resource Graph Explorer](../azure_arc_jumpstart/azure_arc_servers/day2_scenarios/arc_inventory_tagging/)

* [Deploying Microsoft Monitoring Agent Extension (MMA) to Azure Arc Linux and Windows VMs using Extension Management](../azure_arc_jumpstart/azure_arc_servers/day2_scenarios/arc_vm_extension_mma_arm/)

* [Deploying Custom Script Extension to Azure Arc Linux and Windows VMs using Extension Management](../azure_arc_jumpstart/azure_arc_servers/day2_scenarios/arc_vm_extension_customscript_arm/)

* [Deploying Microsoft Monitoring Agent Extension (MMA) to Azure Arc Linux and Windows VMs using Azure Policies](../azure_arc_jumpstart/azure_arc_servers/day2_scenarios/arc_policies_mma/)
 
* [Integrate Azure Security Center with Azure Arc enabled Servers](../azure_arc_jumpstart/azure_arc_servers/day2_scenarios/arc_securitycenter/)

* [Integrate Azure Sentinel with Azure Arc enabled Servers](../azure_arc_jumpstart/azure_arc_servers/day2_scenarios/arc_azuresentinel/)

* [Deploy Update Management on Azure Arc enabled Servers](../azure_arc_jumpstart/azure_arc_servers/day2_scenarios/arc_updatemanagement/)
...
* [Deploy GitOps configurations and perform basic GitOps flow on AKS as an Azure Arc Connected Cluster](../azure_arc_jumpstart/azure_arc_k8s/day2_scenarios/aks/aks_gitops_basic/)

* [Deploy GitOps configurations and perform Helm-based GitOps flow on AKS as an Azure Arc Connected Cluster](../azure_arc_jumpstart/azure_arc_k8s/day2_scenarios/aks/aks_gitops_helm/)

* [Integrate Azure Monitor for Containers with AKS as an Azure Arc Connected Cluster](../azure_arc_jumpstart/azure_arc_k8s/day2_scenarios/aks/aks_monitor/)

* [Apply GitOps configurations on AKS as an Azure Arc Connected Cluster using Azure Policy for Kubernetes](../azure_arc_jumpstart/azure_arc_k8s/day2_scenarios/aks/aks_policy/)

#### GKE

* [Deploy GitOps configurations and perform basic GitOps flow on GKE as an Azure Arc Connected Cluster](../azure_arc_jumpstart/azure_arc_k8s/day2_scenarios/gke/gke_gitops_basic/)

* [Deploy GitOps configurations and perform Helm-based GitOps flow on GKE as an Azure Arc Connected Cluster](azure_arc_jumpstart/azure_arc_k8s/../day2_scenarios/gke/gke_monitor/)

* [Integrate Azure Monitor for Containers with GKE as an Azure Arc Connected Cluster](../azure_arc_jumpstart/azure_arc_k8s/day2_scenarios/gke/gke_monitor/)

* [Apply GitOps configurations on GKE as an Azure Arc Connected Cluster using Azure Policy for Kubernetes](../azure_arc_jumpstart/azure_arc_k8s/day2_scenarios/gke/gke_policy/)

#### kind

* [Deploy GitOps configurations and perform Helm-based GitOps flow on kind as an Azure Arc Connected Cluster](../azure_arc_jumpstart/azure_arc_k8s/day2_scenarios/kind/local_kind_gitops_helm/)

#### MicroK8s

* [Deploy GitOps configurations and perform Helm-based GitOps flow on MicroK8s as an Azure Arc Connected Cluster](../azure_arc_jumpstart/azure_arc_k8s/day2_scenarios/microk8s/local_microk8s_gitops_helm/)
